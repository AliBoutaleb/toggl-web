...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		construct: function(item, config) {
			 ...
			 */
			me.chart = me;
			me.controller = me; // chart.chart.modules #inception
			...
			if (!context || !canvas) {
				...
				// the chart initialization but after setting basic chart / modules properties that
 ...
 * since responsiveness is handled by the modules.resize() method. The config is used
...
defaults._set('global', {
	legend: {
		...
		onClick: function(e, legendItem) {
			...
			// See modules.isDatasetVisible comment
